...
contextBridge.exposeInMainWorld('boxscoreApi', {
  ...
  saveShotZoneEntry: (params) => ipcRenderer.invoke('db:save-shot-zone-entry', params),
  findGameByMatchup: (params) => ipcRenderer.invoke('db:find-game-by-matchup', params),
  listShotZoneEntriesForGame: (gameId) => ipcRenderer.invoke('db:list-shot-zone-entries-for-game', gameId),
  deleteShotZoneEntry: (id) => ipcRenderer.invoke('db:delete-shot-zone-entry', id),
